...
module.exports = function (lang) {
    return Joi.object({
        ...
        essayPackageUuid: Joi.string().guid({ version: 'uuidv4' }).optional().error(new Error(lang.USER_ESSAY.ESSAY_PACKAGE_UUID_NOT_VALID)),
        ...
        backgroundDescription: Joi.string().max(2000).allow('', null).optional().error(new Error(lang.USER_ESSAY.BACKGROUND_DESCRIPTION_NOT_VALID)),
