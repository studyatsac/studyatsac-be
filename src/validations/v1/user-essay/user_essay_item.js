...
module.exports = function (lang) {
    return Joi.object({
        ...
        answer: Joi.string().max(20000).required().error(new Error(lang.USER_ESSAY_ITEM.ANSWER_NOT_VALID)),
        review: Joi.string().max(20000).allow('', null).optional().error(new Error(lang.USER_ESSAY_ITEM.REVIEW_NOT_VALID))
    });
};
