...
module.exports = function (lang) {
    return Joi.object({
        ...
        interviewSectionQuestionUuid: Joi.string().guid({ version: 'uuidv4' }).optional().error(new Error(lang.USER_INTERVIEW_SECTION_ANSWER.INTERVIEW_SECTION_QUESTION_UUID_NOT_VALID)),
