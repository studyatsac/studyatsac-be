...
module.exports = function (lang) {
    return Joi.object({
        ...
        externalTransactionId: Joi.string().max(45).optional().error(new Error(lang.USER_PURCHASE.EXTERNAL_TRANSACTION_ID_NOT_VALID)),
        expiredAt: Joi.date().optional().error(new Error(lang.USER_PURCHASE.EXPIRED_AT_NOT_VALID))
    });
};
