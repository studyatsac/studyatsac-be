 ...
 * 10 seconds
 */
const TRANSITION_CHECKER_DELAY_IN_SECONDS = 10;
/**
 * 10 seconds
 */
const TRANSITION_CHECKER_DELAY_IN_MILLISECONDS = TRANSITION_CHECKER_DELAY_IN_SECONDS * 1000;
/**
 * 1 minute
 */
...
module.exports = {
    ...
    TRANSITION_CHECKER_DELAY_IN_SECONDS,
    TRANSITION_CHECKER_DELAY_IN_MILLISECONDS,
    STATUS,
    EVENT_NAME,
