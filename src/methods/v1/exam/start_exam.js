const StartExamValidation = require('../../../validations/v1/exam/start_exam');
...
exports.postStartExam = async (req, res) => {
    try {
        ...
        try {
            input = await StartExamValidation(lang).validateAsync(body);
        } catch (err) {
        ...
        const result = await ExamService.startExam(input, { lang });
